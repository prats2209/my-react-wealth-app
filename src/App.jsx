                ...
                return (
                    <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 md:p-10 w-full max-w-md border border-gray-200">
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <img src={LogInIconURL} alt="Login Icon" className="w-5 h-5" />
                                <span>Log In</span>
                            </button>
                        </div>
                ...
                return (
                    <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 md:p-10 w-full max-w-md border border-gray-200">
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <img src={UserPlusIconURL} alt="User Plus Icon" className="w-5 h-5" />
                                <span>Register</span>
                            </button>
                        </div>
                        <div className="text-center mt-4">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 md:p-10 w-full max-w-3xl border border-gray-200">
                        ...
                        {currentUser ? (
                            <div className="text-center text-gray-700 mb-6">
                                ...
                                >
                                    <img src={LogOutIconURL} alt="LogOut Icon" className="w-5 h-5" />
                                    <span>Log Out</span>
                                </button>
                            </div>
                        ) : (
